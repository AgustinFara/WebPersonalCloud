...
#   path('portfolio', views.portfolio, name='portfolio'), #Página de portfolio
    ...
    path('chart/<str:fecha>/', views.chart, name='chart_con_fecha'), # Caso con fecha
    path('noticias/<str:nombre>/<str:fecha>/', views.noticias_por_protagonista, name='ver_noticias'),
    # ex: /polls/5/
